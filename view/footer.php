    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary text-center" id="exampleModalLabel"> &nbsp;&nbsp;¿Listo para salir?</h5>
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-success" href="index.php?c=<?=database::encryptor('encrypt', 'user')?>&a=<?=database::encryptor('encrypt', 'logout')?>">
